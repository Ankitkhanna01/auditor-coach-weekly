...
const steps = [
  { 
    ...
    desc: "Look for the square icon with an arrow pointing up at the bottom of Safari's toolbar" 
  },
  { 
    step: 2,
    title: "Scroll down in the menu", 
    desc: "Find and tap 'Add to Home Screen' option in the share menu" 
  },
  { 
    step: 3,
    title: "Tap 'Add'", 
    desc: "Confirm by tapping 'Add' in the top right corner" 
  },
];
